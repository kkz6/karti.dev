    ...
    return (
        <li>
            ...
            >
                ...
                {isActive && <span aria-hidden="true" className="bg-primary/10 ring-primary/20 absolute inset-0 rounded-full ring-1" />}
                        ...
                        <div className="absolute inset-y-0 left-0 flex items-center">
                            <div
                                className={clsx(
                                    ...
                                    showNavAvatar ? 'translate-y-0 opacity-100' : 'pointer-events-none -translate-y-1 opacity-0',
                                )}
                            >
                                <AvatarContainer>
                                    <Avatar />
