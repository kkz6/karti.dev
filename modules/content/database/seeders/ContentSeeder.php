...
use Modules\Content\Models\{
    Article, Project, Category, Tag, Technology, PhotoCollection, Photo,
    SpeakingEvent, WorkExperience, ToolCategory, Tool, SocialLink, SiteSetting
};
...
class ContentSeeder extends Seeder
{
    ...
    private function createProjects(array $categories, array $technologies): void
    {
        ...
        foreach ($projectsData as $projectData) {
            ...
            $project->technologies()->attach($technologies[array_rand($technologies)]->id);
            $project->technologies()->attach($technologies[array_rand($technologies)]->id);
        }
    }
