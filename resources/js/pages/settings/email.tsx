...
import { Check, Eye, EyeOff, LockKeyhole, Mail, Save, Server } from 'lucide-react';
...
export default function EmailSettingsPage({ emailSettings, passwordConfigured, environmentMailer }: EmailSettingsPageProps) {
    ...
    function submit(event: FormEvent) {
        ...
        form.put(route('admin.settings.email.update'), {
            ...
            onSuccess: (page) => {
                ...
                const next = { ...saved, password: '', clear_password: false };
                form.setData(next);
        ...
        <AppLayout breadcrumbs={[{ title: 'Email settings', href: route('admin.settings.email.edit') }]}>
            ...
            <PageContainer as="form" onSubmit={submit} className="content-index space-y-6">
                ...
                <p className="text-muted-foreground max-w-2xl text-sm leading-relaxed">
                    Configure the SMTP server used for newsletter confirmations, password resets, and other application email. Saved credentials
                    override the server environment only when custom delivery is enabled.
                </p>
                        ...
                        <CardContent className="flex flex-col gap-4 pt-6 sm:flex-row sm:items-center sm:justify-between">
                            <div className="min-w-0">
                                ...
                                <p className="text-muted-foreground mt-1 text-sm leading-relaxed">
                                    {data.enabled
                                        ? 'Outgoing email uses the credentials saved below.'
                            ...
                            <span id="email-settings-mode" className="sr-only">
                                {data.enabled ? 'Custom SMTP delivery enabled' : 'Server environment delivery enabled'}
                            </span>
                        </CardContent>
                    </Card>
                        ...
                        <CardHeader>
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <CardDescription className="mt-1">Connection details supplied by your email provider.</CardDescription>
                                </div>
                            </div>
                        </CardHeader>
